...
-- Note: Existing products will need slugs generated manually or via admin panel
-- The slugs should follow these rules:
-- 1. All lowercase
-- 2. Latin letters only (Georgian transliterated)
